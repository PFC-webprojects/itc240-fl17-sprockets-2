...
<?php	
	...
	switch($day){
		...
		case 'Tuesday':
			...
			$color = '#C88962';
			$description = ".  Why not get your daily allowance of protein at the same time as your daily dose of caffeine?  Call it a two-for-one coffee -- on $day, of course!";
		break;
		...
		default:
			...
			$pic = 'drip-coffee.jpg';
			$color = '#060604';
			$description = ".  Ho hum.  What a $coffee.  We're out of everything else today.  That's what every $day is always like around here.  Sorry!";
...
?>
	...
	<div class="navbar-collapse">
		<p style="white-space:pre-wrap"><a style="color:black" class="text-expanded text-uppercase" href="?day=<?=TODAY?>"><strong><?=$day?>'s</strong></a> daily special is <strong><?=$coffee?></strong><?=$description?></p>
		<p>Curious about what our daily specials are on the other days of the week?&nbsp; Have a look through the links below!</p>
	</div>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-faded py-lg-4">
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav mx-auto">
            ...
            <li class="nav-item px-lg-1">
              <a class="nav-link text-uppercase text-expanded" href="?day=Holiday">Holiday</a>
            </li>
          </ul>
        </div>
	</nav>
