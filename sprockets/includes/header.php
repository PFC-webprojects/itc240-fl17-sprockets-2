...
<html lang="en">
  ...
  <head>
    ...
    <title><?=$config->title?></title>  <!--  $config->title  gets set in  config.php  -->
  ...
  <body>
	...
	<div class="tagline-lower text-center text-expanded text-shadow text-uppercase text-white mb-5 d-none d-lg-block"><strong><?=$config->pageID?></strong></div>
